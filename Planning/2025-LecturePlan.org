...
* DONE Assignment Parts
CLOSED: [2025-08-18 mån 14:33]
:LOGBOOK:
- State "DONE"       from "TODO"       [2025-08-18 mån 14:33]
:END:
Assessments:
1. Git, Getting started with Containers, Testing/Debugging
2. Implementation and Documentation
...
5. [ ] Engineering Diary
   ...
   2. Submit on Canvas
* DONE Lecture Plan
CLOSED: [2025-08-18 mån 14:32]
:LOGBOOK:
- State "DONE"       from "TODO"       [2025-08-18 mån 14:32]
:END:
** DONE Week 1 [4/4]
...
** DONE Week 7 [4/4]
CLOSED: [2025-08-18 mån 14:29]
:LOGBOOK:
- State "DONE"       from "TODO"       [2025-08-18 mån 14:29]
:END:
1. [X] Lecture: Introduktion till JavaScript
2. [X] Lecture: Application Development
3. [X] Practical: Buffert
4. [X] Lab: Develop a new microservice III (one microservice, simple web UI) (*Show to TA*)
** DONE Week 8 [4/4]
...
:END:
* DONE Update Lectures
CLOSED: [2025-08-18 mån 14:32]
:LOGBOOK:
- State "DONE"       from "TODO"       [2025-08-18 mån 14:32]
:END:
- [X] All Lectures delete "Nästa Föreläsning"
- [X] Lecture 1: Föreläsningsordning, struktur på kursen, inlämningsuppgifter, övningsuppgifter
- [X] Lecture 1: Verktyg
- [X] Lecture 1: Flytta "An Executing Program" till Lektion 2 "Datorn och dess beståndsdelar"
- [X] Lecture "Virtualisation" -- make it more hands-on.
